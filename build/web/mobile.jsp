...
//                          out.print(s1);
                        ...
                        PreparedStatement st = con.prepareStatement("Select * from addsubcategory where category = '"+s1+"'");
                        ...
                        while (rs.next()) {
                    String subimg = rs.getString("subimg");
                    imageFileNames.add(subimg);
    ...
    <div class="single-products">
        <div class="productinfo text-center">
                ...
                <img src="<%= subimg %>">
                      ...
                      <a href="android.jsp?subcategory=<%=rs.getString("subcategory")%>" class="btn btn-default add-to-cart"><%=rs.getString("subcategory")%></a>
                            </div>
                        </div>
