<%-- 
    Document   : dashboard
    Created on : 8 Nov, 2023, 6:12:03 PM
    Author     : 91848
--%>
...
<div class="sidebar">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header clearfix">Categories List
                    <a href="admin.jsp?page=dashboard.jsp" class="btn btn-primary pull-right">Add new</a>
                </h3>
...
<!--                                    <th>cate_image</th>-->
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <td style="width: 200px"><%=rs.getString("cid")%></td>
                                    <td><%=rs.getString("cname")%></td>
                                    
                                    <td>
                                        <a href="admin.jsp?page=dashboard.jsp&Edit=<%=rs.getString("cid")%>" class="btn btn-success">Edit</a>

   
                                    </td>
                                    <td>
                                        <a  onclick="return confirm('Are You Sure Delete categories Data?')"href="admin.jsp?page=dashboard.jsp&Delete=<%=rs.getString("cid")%>"class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <%
                                    }
