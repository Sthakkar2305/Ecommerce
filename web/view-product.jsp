<%-- 
    ...
    Created on : 19 Feb, 2024, 2:09:41 PM
    Author     : 91848
--%>
...
<html>
    ...
    <body>
        <div class="admin-panel">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header clearfix">product List
                        <a href="adminproduct.jsp?page=view-product.jsp" class="btn btn-primary pull-right">Add new</a>
                    </h3>
                            ...
                            <table border="0" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        PreparedStatement st = con.prepareStatement("Select * from addproduct");
                                ...
                                <a href="adminproduct.jsp?page=view-product.jsp&Edit=<%=rs.getString("id")%>" class="btn btn-success">Edit</a>


                                </td>
                                <td>
                                    
                                    <a  onclick="return confirm('Are You Sure Delete categories Data?')"href="adminproduct.jsp?page=view-product.jsp&Delete=<%=rs.getString("id")%>"class="btn btn-danger">Delete</a>
                                </td>
                                </tr>
                                <%
                                    }
